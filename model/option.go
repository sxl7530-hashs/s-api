...
func InitOptionMap() {
	...
	common.OptionMap["InviterRebatePercent"] = strconv.FormatFloat(common.InviterRebatePercent, 'f', -1, 64)
	...
	common.OptionMap["GeminiImageSizeRatio"] = ratio_setting.GeminiImageSizeRatio2JSONString()
	common.OptionMap["KlingPointRatio"] = ratio_setting.KlingPointRatio2String()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "InviterRebatePercent":
		common.InviterRebatePercent, _ = strconv.ParseFloat(value, 64)
	...
	case "GeminiImageSizeRatio":
		err = ratio_setting.UpdateGeminiImageSizeRatioByJSONString(value)
	case "KlingPointRatio":
		err = ratio_setting.UpdateKlingPointRatio(value)
	case "TopUpLink":
