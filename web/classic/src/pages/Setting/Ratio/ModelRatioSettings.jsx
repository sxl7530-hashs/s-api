    ...
    <Spin spinning={loading}>
      ...
      >
        ...
        <Row gutter={16}>
          <Col xs={24} sm={16}>
            <Form.TextArea
              label={t('Gemini 图片尺寸倍率')}
              extraText={t(
                'Gemini 画图按尺寸计费，键为图片尺寸 (1K/2K/4K)，值为倍率',
              )}
              placeholder={'{"1K": 1, "2K": 1, "4K": 1.5}'}
              field={'GeminiImageSizeRatio'}
              ...
              onChange={(value) =>
                setInputs({ ...inputs, GeminiImageSizeRatio: value })
              }
            />
          </Col>
        </Row>
        <Row gutter={16}>
          <Col xs={24} sm={8}>
            <Form.Input
              label={t('可灵点倍率 (Kling Point Ratio)')}
              extraText={t('可灵平台计费倍率，浮点数。最终费用 = 可灵点 × 此倍率 × 分组倍率')}
              placeholder={'0.78'}
              field={'KlingPointRatio'}
              onChange={(value) =>
                setInputs({ ...inputs, KlingPointRatio: value })
              }
            />
          </Col>
        </Row>
