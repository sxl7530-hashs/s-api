...
export function normalizeUserData(data) {
  ...
  return {
    ...data,
    token: data.token || storedUser.token,
    access_token: data.access_token || storedUser.access_token,
    access_expires_at: data.access_expires_at || storedUser.access_expires_at,
    session: data.session || storedUser.session,
  };
}
