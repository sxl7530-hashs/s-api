...
import TokenGroupProfilesSetting from '../../pages/Setting/Model/TokenGroupProfilesSetting';
    ...
    <Card style={{ marginTop: '10px' }}>
      <Tabs type='card' defaultActiveKey='pricing'>
        ...
        <Tabs.TabPane tab={t('工具调用定价')} itemKey='tool_price'>
          {loadingContent(<ToolPriceSettings options={inputs} />)}
        </Tabs.TabPane>
      </Tabs>
    </Card>
  );
