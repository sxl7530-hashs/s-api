  ...
  const renderMarkdownNotice = () => {
    ...
    return (
      <div
        ...
        className='notice-content-scroll notice-themed-content max-h-[55vh] overflow-y-auto pr-2'
      />
    );
  };
            ...
            return (
              <Timeline.Item
                ...
                extra={
                  item.extra ? (
                    <div
                      className='notice-themed-content text-xs notice-themed-muted'
              ...
              >
                <div
                  className='notice-themed-content'
