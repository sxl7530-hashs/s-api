      ...
      {!isLoading && (
        ...
        >
          <Button
            ...
            className={`!rounded-full ${shouldDisableActions ? '!text-semi-color-text-3 !cursor-not-allowed' : '!text-semi-color-text-3 hover:!text-blue-600 hover:!bg-blue-50'} ${styleState.isMobile ? '!w-6 !h-6' : '!w-7 !h-7'} !p-0 transition-all`}
            aria-label={t('重试')}
          />
        </Tooltip>
      )}
      ...
      {canEdit && (
        ...
        >
          <Button
            ...
            disabled={shouldDisableActions}
            className={`!rounded-full ${shouldDisableActions ? '!text-semi-color-text-3 !cursor-not-allowed' : '!text-semi-color-text-3 hover:!text-yellow-600 hover:!bg-yellow-50'} ${styleState.isMobile ? '!w-6 !h-6' : '!w-7 !h-7'} !p-0 transition-all`}
            aria-label={t('编辑')}
          />
        </Tooltip>
      )}
      ...
      {canToggleRole && !isLoading && (
        ...
        >
          <Button
            ...
            disabled={shouldDisableActions}
            className={`!rounded-full ${shouldDisableActions ? '!text-semi-color-text-3 !cursor-not-allowed' : message.role === 'system' ? '!text-purple-500 hover:!text-purple-700 hover:!bg-purple-50' : '!text-semi-color-text-3 hover:!text-purple-600 hover:!bg-purple-50'} ${styleState.isMobile ? '!w-6 !h-6' : '!w-7 !h-7'} !p-0 transition-all`}
            aria-label={
              message.role === 'assistant'
                ? t('切换为System角色')
                : t('切换为Assistant角色')
      ...
      {!isLoading && (
        ...
        >
          <Button
            ...
            disabled={shouldDisableActions}
            className={`!rounded-full ${shouldDisableActions ? '!text-semi-color-text-3 !cursor-not-allowed' : '!text-semi-color-text-3 hover:!text-red-600 hover:!bg-red-50'} ${styleState.isMobile ? '!w-6 !h-6' : '!w-7 !h-7'} !p-0 transition-all`}
            aria-label={t('删除')}
          />
        </Tooltip>
      )}
