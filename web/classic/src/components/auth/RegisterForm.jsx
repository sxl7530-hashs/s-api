...
const RegisterForm = () => {
  ...
  return (
    <div
      className='classic-page-fill relative overflow-hidden flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8'
