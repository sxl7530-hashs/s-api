        ...
        cover={
          <div
            ...
            style={{
              ...
              backgroundImage: `linear-gradient(0deg, rgba(var(--palette-primary-darkerChannel) / 80%), rgba(var(--palette-primary-darkerChannel) / 80%)), url('/classic/cover-4.webp')`,
                                ...
                                icon={
                                  payMethod.type === 'alipay' ? (
                                    ...
                                    <img
                                      src={
                                        actualTheme === 'dark'
                                          ? '/classic/waffo-logo-dark.svg'
                                          : '/classic/waffo-logo-light.svg'
                                      }
                                      alt='Waffo'
                                      style={{
                                        width: 18,
