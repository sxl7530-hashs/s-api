...
func setupTaskPluginBindChannelTest(t *testing.T) {
	...
	require.NoError(t, database.AutoMigrate(&model.Channel{}, &model.ChannelCostRatioHistory{}, &model.Ability{}, &model.CasbinRule{}, &model.AuthzRole{}, &model.Log{}, &model.User{}))
	model.DB = database
